...
function UpdateUserForm() {
    ...
    return (
        <form className='grid lg:grid-cols-2 w-4/6 gap-4' onSubmit={handleSubmit}>
            ...
            <button className='flex justify-center text-sm w-2/6 bg-yellow-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-yellow-500 hover:text-yellow-500'>Update <span className='px-1'><BiPlus size={24}></BiPlus></span></button>
        </form>
    )
}
